...
const data = [
  {
    ...
    value: 249,
    chartData: [
      { month: "January", value: 309 },
      { month: "February", value: 269 },
      { month: "March", value: 286 },
      { month: "April", value: 312 },
      { month: "May", value: 187 },
      { month: "June", value: 249 },
      { month: "July", value: 275 },
      { month: "August", value: 293 },
      { month: "September", value: 305 },
      { month: "October", value: 289 },
      { month: "November", value: 326 },
      { month: "December", value: 341 },
    ],
    change: "33%",
    changeType: "positive",
    xaxis: "month",
  },
  {
    ...
    chartData: [
      ...
      { month: "February", value: 1256 },
      { month: "March", value: 1123 },
      { month: "April", value: 1300 },
      { month: "May", value: 943 },
      { month: "June", value: 943 },
      { month: "July", value: 1089 },
      { month: "August", value: 1245 },
      { month: "September", value: 1190 },
      { month: "October", value: 1350 },
      { month: "November", value: 1159 },
      { month: "December", value: 1275 },
    ],
    change: "0%",
    changeType: "neutral",
    xaxis: "month",
  },
  {
    ...
    chartData: [
      ...
      { month: "July", value: 25000 },
      { month: "August", value: 50000 },
      { month: "September", value: 35000 },
      { month: "October", value: 28441 },
      { month: "November", value: 32000 },
      { month: "December", value: 30500 },
    ],
    change: "19%",
    changeType: "negative",
    xaxis: "month",
          ...
          <section className={"flex flex-wrap justify-between"}>
            <div className="flex flex-col justify-between gap-y-2 p-4">
              ...
              >
                ...
                <span>{change}</span>
                <span className="text-default-400 dark:text-default-500"> {" "} vs {xaxis === "day" ? "yesterday" : "last " + xaxis}</span>
              </div>
            </div>
