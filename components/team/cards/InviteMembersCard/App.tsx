...
interface InviteMembersCardProps extends React.HTMLAttributes<HTMLDivElement> {
  className?: string;
}
...
export default function InviteMembersCard({className, ...rest}: InviteMembersCardProps) {
  return (
