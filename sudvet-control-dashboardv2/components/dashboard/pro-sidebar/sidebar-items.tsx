    ...
    items: [
      {
        ...
        items: [
          { key: "shareholders", href: "#", title: "Shareholders" },
          { key: "note_holders", href: "#", title: "Note Holders" },
          { key: "transactions_log", href: "#", title: "Transactions Log" },
        ],
      },
      { key: "analytics", href: "#", icon: "solar:chart-outline", title: "Analytics" },
      {
        key: "perks",
        href: "/perks",
        icon: "solar:gift-linear",
      ...
      { key: "expenses", href: "#", icon: "solar:bill-list-outline", title: "Expenses" },
